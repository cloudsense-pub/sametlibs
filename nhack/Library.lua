-- OVERKILL_NHACK_MAINWINDOW_RESTYLE
--[[
 2/22/2026
 Library.lua
 Purpose:
...
do
 ...
 local Buffer = {}
 if Current then
 Buffer[#Buffer + 1] = string.format(" Now playing \n%s\n%s",
 ...
 Library:Create("UIStroke", {
 Name = "\0",
 Parent = Items["WindowTitle"].Instance,
 LineJoinMode = Enum.LineJoinMode.Miter
 })

 Items["WindowSubtitle"] = Library:Create("TextLabel", {
 Name = "\0",
 Parent = Items["TitleBar"].Instance,
 FontFace = Library.Font,
 TextSize = Library.FontSize,
 Text = tostring(Params.Subtitle or Params.subtitle or Params.RightText or Params.rightText or ""),
 TextColor3 = Library.Theme["Accent"],
 BackgroundTransparency = 1,
 BorderSizePixel = 0,
 AnchorPoint = Vector2.new(1, 0.5),
 ...
 Library:Create("UIStroke", {
 Name = "\0",
 Parent = Items["WindowSubtitle"].Instance,
 LineJoinMode = Enum.LineJoinMode.Miter
 })

 Items["TitleDivider"] = Library:Create("Frame", {
 Name = "\0",
 Parent = Items["MainFrame"].Instance,
 ...
 if Items["WindowTitle"] and Items["WindowTitle"].Instance then
 Items["WindowTitle"].Instance.Text = Window.Title
 end
 end

 function Window:SetSubtitle(Text)
 local Value = tostring(Text or "")
 if Items["WindowSubtitle"] and Items["WindowSubtitle"].Instance then
 Items["WindowSubtitle"].Instance.Text = Value
 end
 end
 ...
 Items["SubUnderline"] = Library:Create("Frame", {
 Name = "\0",
 Parent = Items["Inactive"].Instance,
 AnchorPoint = Vector2.new(0, 1),
 ...
 Items["SubUnderline"]:Tween({ BackgroundTransparency = 0 })
 else
 Items["Inactive"]:ChangeItemTheme({ TextColor3 = "Inactive Text" })
 Items["Inactive"]:Tween({ TextColor3 = Library.Theme["Inactive Text"] })
 Items["SubUnderline"]:Tween({ BackgroundTransparency = 1 })
 end
 ...
 Items["SectionAccent"] = Library:Create("Frame", {
 Name = "\0",
